...
ActiveRecord::Schema.define(version: 20170227034456) do
  ...
  create_table "settings", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["thing_type", "thing_id", "var"], name: "index_settings_on_thing_and_var", unique: true
  end
  ...
  create_table "solidus_liquid_assets", force: :cascade do |t|
    ...
    t.index ["key"], name: "index_solidus_liquid_assets_on_key"
    t.index ["theme_id"], name: "index_solidus_liquid_assets_on_theme_id"
  end

  create_table "solidus_liquid_link_lists", force: :cascade do |t|
    t.string   "name"
    t.string   "slug"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_solidus_liquid_link_lists_on_slug"
  end

  create_table "solidus_liquid_links", force: :cascade do |t|
    t.string   "name"
    t.string   "url"
    t.integer  "link_list_id"
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["link_list_id"], name: "index_solidus_liquid_links_on_link_list_id"
  end

  create_table "solidus_liquid_pages", force: :cascade do |t|
    t.string   "author"
    t.string   "name"
    t.string   "slug"
    t.text     "body_html"
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["slug"], name: "index_solidus_liquid_pages_on_slug"
  end
  ...
  create_table "spree_taxons", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_spree_taxons_on_slug"
